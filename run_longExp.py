...
parser = argparse.ArgumentParser(description='RobustMTSF for Time Series Forecasting')
...
parser.add_argument('--model', type=str, required=False, default='RobustMTSF',
                    help='model name, options: [Autoformer, Informer, Transformer]')

# data loader
parser.add_argument('--data', type=str, required=False, default='custom', help='dataset type')
parser.add_argument('--root_path', type=str, default='./dataset', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='Flight.csv', help='data file')
parser.add_argument('--features', type=str, default='M',
                    help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate,'
                         ' S:univariate predict univariate, MS:multivariate predict univariate')
parser.add_argument('--target', type=str, default='UUEE', help='target feature in S or MS task')
...
parser.add_argument('--top_k', type=int, default=3, help='for ScaleBlock')
...
#GCN
parser.add_argument('--node_dim', type=int, default=30, help='each node embbed to dim dimentions')
...
parser.add_argument('--e_layers', type=int, default=1, help='num of encoder layer')
parser.add_argument('--d_layers', type=int, default=1, help='num of decoder layer')
